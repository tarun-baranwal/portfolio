...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      desc: 'A premium, modern portfolio website featuring a light ambient glassmorphic aesthetic. Built with fluid scroll animations, glowing neo-morphic elements, and highly responsive structural layouts.',
